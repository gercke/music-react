...
import SJQSongOperationBar from '@/components/song-operation-bar';
import {
  RankingHeaderWrapper
} from './style';

export default memo(function SJQRankingHeader() {
  // redux
  ...
  return (
    <RankingHeaderWrapper>
      ...
      <div className="info">
        ...
        <SJQSongOperationBar favorTitle={`(${topInfo.subscribedCount})`}
